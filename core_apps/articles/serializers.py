...
class TagListField(serializers.Field):
    """Handling tags as a list of strings"""
...
class ArticleSerializer(serializers.ModelSerializer):
    ...
    responses_count = serializers.IntegerField(source="responses.count", read_only=True) #responses is the related_name on Responses Model to Article
    ...
    def create(self, validated_data):
        """Overriding the create method of the serializer class"""
        tags = validated_data.pop("tags")
        article = Article.objects.create(**validated_data)
        article.tags.set(tags) #tags _TaggableManager #set method from _TaggableManager
        return article
    ...
    class Meta:
        ...
        fields = [
            ...
            "bookmarks","bookmarks_count","responses","responses_count","claps_count",
